	                  ...
	                  <div class="x_content">
	                    <table id="datatable" class="table table-striped table-bordered table-hover">
					        ...
					        <c:forEach items="${pageInfo.list}" var="type">
					        	<tr>
					                         ...
					                         <th>${type.typename}</th>
					                         <th>
												<a href="${pageContext.request.contextPath }/manage/flatform/type/toupdate?protypeid=${type.protypeid}" class="btn btn-primary btn-xs">修改</a></li>
						...
						<div class="row">
							...
							<div class="col-md-6">
								...
								<ul class="pagination">
									<li><a href="${pageContext.request.contextPath }/manage/flatform/type/getall?pn=1">首页</a></li>
									<c:if test="${pageInfo.hasPreviousPage }">
										<li><a href="${pageContext.request.contextPath }/manage/flatform/type/getall?pn=${pageInfo.pageNum-1}"
									...
									<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
										...
										<c:if test="${page_Num != pageInfo.pageNum }">
											<li><a href="${pageContext.request.contextPath }/manage/flatform/type/getall?pn=${page_Num }">${page_Num }</a></li>
										</c:if>
									...
									<li><a href="${pageContext.request.contextPath }/manage/flatform/type/getall?pn=${pageInfo.pages}">末页</a></li>
								</ul>
								</nav>
							</div>
						</div>
...
<script type="text/javascript">
	function del(id) {
		...
		if (message==true) {
			// 确认时做的操作 var
			window.location.href="${pageContext.request.contextPath }/manage/flatform/type/delete?protypeid="+id;
			alert("删除成功");
	} else {
		// 取消时做的操作
		alert("删除失败");
