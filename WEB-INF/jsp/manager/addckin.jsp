<%@ page language="java" contentType="text/html; charset=UTF-8"
         ...
         <%@include file="common/head.jsp"%>
         	...
         	<form class="form-horizontal form-label-left" method="post"
                   action="${pageContext.request.contextPath }/manage/flatform/ckin/insert"
                   onsubmit="return checkall()">
                               ...
                               <div class="item form-group">
                                 ...
                                 <div class="col-md-6 col-sm-6 col-xs-5">
                                   <input id="inid" name="inid" class="form-control input-small input-sm " value="${ckin.inid}" onblur="checkinid()" type="text" ><span id="demo1" style="color: red;"></span>
                                 </div>
                               </div>
                               <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-5">
                                       <input id="proid" name="proid" class="form-control input-small input-sm"
                                              value="${proid}" type="text" onblur="checkproid()"
                                              <c:if test="${not empty proid}">readonly</c:if>>
                               ...
                               <div class="item form-group">
                                   ...
                                   <div class="col-md-6 col-sm-6 col-xs-5">
                                       <input id="pname" name="pname" class="form-control col-md-7 col-xs-5"
                                              value="${pname}" type="text" onblur="checkname()"
                                              <c:if test="${not empty pname}">readonly</c:if>>
                              ...
                              <div class="item form-group">
         						...
         						<a href="${pageContext.request.contextPath }/manage/flatform/kcxx/kcxxWithPronum" class=" text-left btn btn-default" role="button">返回上页</a>
         ...
         function checkname(){
         // 如果字段是只读的，跳过验证
             if(document.getElementById('pname').readOnly) {
         ...
         function checkproid()
         {
             if(document.getElementById('proid').readOnly) {
