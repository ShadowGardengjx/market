<%@ page language="java" contentType="text/html; charset=UTF-8"
         ...
         <%@include file="common/head.jsp"%>
         	...
         	<form class="form-horizontal form-label-left" method="post"
                   action="${pageContext.request.contextPath }/staff/flatform/ckin/insert"
                   onsubmit="return checkall()">
                              ...
                              <div class="item form-group">
         						...
         						<a href="${pageContext.request.contextPath }/staff/flatform/kcxx/kcxxWithPronum" class=" text-left btn btn-default" role="button">返回上页</a>
