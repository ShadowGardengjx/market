...
@Controller
@RequestMapping("/manage/flatform/kcxx")
...
//  跳转到增加页面
  ...
  public String toadd(@RequestParam String proid, @RequestParam String pname, HttpServletRequest request, Model model){
...
//		try {
//			kcxxServiceImp.insertOrUpdate(kcxx);
//		} catch (OptimisticLockingFailureException e) {
//			model.addAttribute("error", "操作失败，数据已被其他用户修改，请刷新后重试");
...
//			}
//		} catch (OptimisticLockingFailureException e) {
//			model.addAttribute("error", "更新失败，库存信息已被其他用户修改，请刷新后重试");
//			return "manager/editkcxx";
//		} catch (Exception e) {
//			model.addAttribute("error", "系统错误: " + e.getMessage());
//			return "manager/editkcxx";
