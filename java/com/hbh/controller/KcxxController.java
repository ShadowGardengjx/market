...
public class KcxxController {
	...
	// 跳转到进货页面并传递商品信息
	@RequestMapping("/toaddCkin")
	public String toaddCkin(@RequestParam String proid, @RequestParam String pname, HttpServletRequest request, Model model) {
		// 将商品ID和名称添加到模型中，以便在JSP页面中使用
		model.addAttribute("proid", proid);
		model.addAttribute("pname", pname);
		return "addckin"; // 这里假设addckin.jsp位于默认视图目录
	}
