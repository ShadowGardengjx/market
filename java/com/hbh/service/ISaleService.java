...
public interface ISaleService {
    ...
    Map<String, Object> trendDataByDate(String startDate, String endDate);
    Map<String, Object> amountData();
    Map<String, Object> amountDataByDate(String startDate, String endDate);
